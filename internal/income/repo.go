...
func (m *Repository) GetIncome24h() (result float64) {
	sql :=
...
func (m *Repository) GetIncome7d() (result float64) {
	sql :=
		fmt.Sprintf(`SELECT avg(expected_earning) * %s as income24h
		FROM expected_earning_result 
...
func (m *Repository) GetIncomeResult() (result float64) {
	sql :=
...
func (m *Repository) GetIncomeHistory() *sql.Rows {
	sql :=
